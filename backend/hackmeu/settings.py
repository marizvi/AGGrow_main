...
SECRET_KEY = 'django-insecure--$5r)%ccirnd4%4cn$br_)#nk#8r@rwm8g-ca2x+=z^4g&h$le'
...
AUTH_USER_MODEL = 'auth_p.User'

API_KEY_CUSTOM_HEADER = "Authorization"
...
WSGI_APPLICATION = 'hackmeu.wsgi.application'
