...
import 'package:hackathon_app/models/http_exception.dart';
...
class Auth with ChangeNotifier {
  ...
  Future<void> login(String? email, String? password) async {
    final url = Uri.parse('https://itsrandom.cf/api/v1/login/');
    ...
    await getUser();
    _autoLogout();
    // final temp = json.decode(userData)['expiryDate'];
    // print(temp);
    // print(DateTime.parse(temp)
    //     .isBefore(DateTime.utc(2029, DateTime.november, 9)));
    notifyListeners();
  }
  ...
  Future<void> getUser() async {
    final url = Uri.parse('https://itsrandom.cf/api/v1/me/');
